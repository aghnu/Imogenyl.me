...
export function PageWA1(props) {
    const content = (
        <div className="content">
            <p className="title"><span className="sub">飒 Stranding Air 品牌宣讲会</span><br/>主题Slogan</p>
    ...
    const content = [
        <div className="content">
            ...
            <p className="left">
                ...
                <br/>
                <br/>这是商业片的取巧,遮不住的东西无限放大变成风格，我在想是不是因为故事地点选在日本，所以在风格上要去靠近日本（ /我们基于流行文化对日本的体验感）这种援引行为和文本之间存在的联系从影史，上看是常见且必然的，只不过在cite流行文化的时候,所援引的往往是一个空壳子（我们对不存在之事物的记忆）……商业片有商业片的规则，我觉得唐探3不算成功吧，虽然它赚很多钱，我总觉得它赚到的是无论如何都会赚到的那部分凑热闹钱，它投机的拼贴布拍片法(据我观察)大家好像并不买账，那你说它是援引不奏效呢，还是它过于奏效之后观众抵触呢，不知道，值得简单撕烤一下
            </p>
        </div>,
        <div className="content">
        ...
        <div className="content">
            ...
            <p className="left">
                ...
                <br/>
                <br/>这不是一个高级低级或正确错误理解的问题，我始终觉得电影自出生起就是大众娱乐产品，那么对大众来说看电影最大的价值是凑热闹的价值，一种群体聚集活动（所以也会产生聚集活动里的一些矛盾，比如有人占了我的坐，导致我以为自己走错排，想问一问结果被骂：你找个空座坐下就得了…….倒是感觉挺春节的) ，并在聚集后和别人有讨论的
                <br/>话题
                <br/>
                <br/>我是看完才知道大家都觉得这是单/双穿越….贾玲刚回到过去的时候我笃定不是穿越,因为这也太生硬了……再看到贾玲想改变过去，就自然而然就代入了我认为最合理的情况：出于某种过于迫切的愿望，偏要强求挽回失去的事物，在梦里试图修正过去（在这之后我几乎就没考虑过穿越的问题）。贾玲撕妈妈结婚证妈妈说她这辈子过得值得的时候，
                <br/>给妈妈的特写，用的是仰拍，我当时觉得奇怪，不明白为什么要这样用。往后看，虽说从这里梦境就开始坍塌了，但其实现实的作用力从一开始就存在，做梦的大脑是已经消化过现实事件的大脑，现实避无可避，只能以别的方式呈现，具体到情节上，就是强迫美满结局过程中遇见的种种困难, 然而越困难，越一定要改…越要做梦，因为心灵尚不能
                <br/>接纳碎裂的真实。
                <br/>
