...
export function PagePW1(props) {
    const content = (
        <div className="content">
            ...
            <p className="left">
                观感上和多年前看行尸走肉差不多⋯⋯本质上都是从“非人性”的到“过于人性”的故事推进，看到第四季已经很疲惫，谏山创努力地填坑，或者说已经在远超期待地填坑，补完了故事的B面，填充 了很多细节，可以看出剧情在他的把控之内，当然这既可以说作是巧思也可以说是匠气 
                <br/>阿尔敏烧焦的时候我要心梗了，面对救埃尔文还是阿尔敏的抉择时我觉得这是我忍耐的极限了⋯⋯ 没想到后面还有，埃尔文举起手的一刻⋯⋯作为全作最纯洁的两个人物，选哪一个都扭转不了他们 的悲剧性，埃尔文的死正是阿尔敏命运的预言，因为纯洁而成为恶魔，在成为恶魔的过程里才被视作半神，最后剩下了什么，只有疲惫，所以理解的人才要放手。杀的是我们在他们身上的寄托(但他们也的确⋯因此更加纯洁)。团兵两个人各自的线都在前情里都趋于饱满了，这一刻的交汇里才能够迷人 
                <br/>对剧情的好感差不多到这里就结束了，第四季真的烂，不单是制作的问题，我能理解为什么观众会失望，前期悬念吊得那么高，最后却以最合常理最容易猜想的方式解答了，人的斗争，人的政治。 第四季运用了一个批判主角的范式，但未免过于直白，事无巨细把观众当做傻子教育，善因得恶果 很好，事与愿违的安排也没问题，但谏山创太想要完整了，这种想做伟大作品的野心简直不可理喻 
                <br/>另一个让人疲惫的点是，难道我们只有存在主义这一条路可以走？前进是什么意思，前进的意思是 there is no promised future，我们只能向前，是不得不，在选择里否定选择。这一困境广泛地存在于这一代作者的弑父母题里：我想要你的爱，你的认可，但我只有杀了你才能超越你，这也是 “不得不”，为时代和命运推动下的必然。如果这是作者想表达的“前进”的悲剧性，好，i'll take it，但用这样的体量去写，太笨重了，我不喜欢 
                <br/>(虽然对人物还是有很多的感情和不舍⋯⋯谁一路看下来不想说，唉，艾伦，小可怜呢！作者想要在这个人物身上传达的东西过载了，连观众都忍不住觉得他无辜)
                <br/>
                <br/>巨人让我不适的还有一点，谏山创自始至终对艾伦都有一种嘲讽的视角/声音，既不幽默也不高明，完全是为了取笑而取笑，这个角色就在他的掌心被抛来抛去，我极其怀疑艾伦的状态被他的心 情状态过度影响⋯⋯这其中的不协调感就是因为他既承认又否定，既想在艾伦身上创造意义又时刻 忍不住嘲讽这么做的自己。 
                ...
                <br/>再发散一点，联系上条提到的这一代作者的弑父母题在巨人剧情里的体现，其实和谏对少年漫传统的矛盾态度是一致的，父辈(的作品)难以超越，我们对少年漫(的套路)的理解和期待正是 被那些作品训练习得的，如何利用的同时反思和创新，这个事是个创作者都会想，就算不能四两拨千斤，也不要包袱这么重吧
            </p>
        </div>
    );
